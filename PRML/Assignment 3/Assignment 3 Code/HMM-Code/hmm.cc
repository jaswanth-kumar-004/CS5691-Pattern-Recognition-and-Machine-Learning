...
//
double HMM::batch_test(char *filename, char *model)
{
  int i;
  int symbol_count;
  ...
  string s;
  string sub = string(filename).substr(3,1);
  if (sub == "2" || sub == "6" || sub == "7" || sub == "9" || sub == "o")
  {
     s = "score" + sub + string(model).substr(5,1) + ".txt";
  }
  else if (string(filename)=="devchA.hmm.seq")
  {
     if (string(model)=="trainchA.hmm.seq.hmm")
	s = "score" + string(filename).substr(3,3) + string(model).substr(5,3) + ".txt";
     else
	s = "score" + string(filename).substr(3,3) + string(model).substr(5,2) + ".txt";

  }
  else
 {
     if (string(model)=="trainchA.hmm.seq.hmm")
	s = "score" + string(filename).substr(3,2) + string(model).substr(5,3) + ".txt";
     else
	s = "score" + string(filename).substr(3,2) + string(model).substr(5,2) + ".txt";
  }
